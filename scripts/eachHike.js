    ...
    db.collection("reviews")
        ...
        .then((allReviews) => {
            ...
            reviews.forEach((doc) => {
                ...
                reviewCard.querySelector(".level").innerHTML = `Status: ${level}`;
                reviewCard.querySelector(".season").innerHTML = `Types of Vehicle: ${season}`;
                reviewCard.querySelector(".scrambled").innerHTML = `Pay Station: ${scrambled}`;
                reviewCard.querySelector(".flooded").innerHTML = `EV Charging Station: ${flooded}`;
